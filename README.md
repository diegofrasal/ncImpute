...
A series of worked examples follow below. More documentation to come. This is [a link](http://example.com){:target="_blank"} that opens in a new window. <a href="http://example.com">http://example.com</a>
